...
public class Review extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        LinearLayout itemReviewVideo = view.findViewById(R.id.textView12);
        ...
        itemReviewVideo.setOnClickListener(v -> {

            Intent intent = new Intent(getActivity(), Listvideo.class);
            startActivity(intent);
        });
